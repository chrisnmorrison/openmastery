...
- **trending**, **topPick**, **popular**: Leave these as false initially, or remove these lines. These create a more dynamic feel for Open Ed, like how many magazine or news websites are organized. The maintainers typically decide these values.
...
- Want to submit an article but you aren't confident in your writing? Don't worry, we all feel that way. That's why Open Ed is completely open source, so we can all work together to write and improve articles
